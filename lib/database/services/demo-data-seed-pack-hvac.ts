...
export const HVAC_DEMO_ESTIMATES: EstimateSeed[] = [
  {
    ...
    notes: "Draft furnace replacement quote — finalize after on-site measurement.",
    createdDaysAgo: 4,
    lineItems: [
      {
  ...
  },
  {
    ...
    notes: "Annual maintenance package sent — awaiting homeowner approval.",
    createdDaysAgo: 12,
    lineItems: [
      {
  ...
  },
  {
    ...
    subtotal: 6200,
    validUntilDaysFromNow: 14,
    notes: "Dual-zone system upgrade declined — customer chose repair-only path for now.",
    createdDaysAgo: 4,
    lineItems: [
      {
        serviceItemKey: "system-replacement",
...
export const HVAC_DEMO_INVOICES: InvoiceSeed[] = [
  ...
  },
  {
    ...
    issueDaysAgo: 25,
    dueDaysFromNow: -10,
    notes: "Capacitor replacement — past due; follow up for payment.",
    lineItems: [
      {
        serviceItemKey: "capacitor",
        name: "Capacitor Replacement",
