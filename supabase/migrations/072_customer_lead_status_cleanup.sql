-- Promote legacy lead-status customers to active, default new customers to active,
-- add demo lead support, and clear demo leads during demo data removal.

update public.customers
set status = 'active'::public.customer_status
where status = 'lead'::public.customer_status;
...
begin
  ...
  delete from public.lead_activities la
