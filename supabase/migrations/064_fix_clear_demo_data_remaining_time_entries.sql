-- Fix clear demo data: delete time records linked to all demo-scoped jobs before job delete.
-- 062 only matched is_demo jobs; 063 also deletes user jobs on demo customers.
-- Remaining job_labor rows get job_id set null (ON DELETE SET NULL) and violate time_entries_check1.
