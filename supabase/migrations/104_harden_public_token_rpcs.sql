-- Public token RPC hardening: restore estimate approval DB validation and
-- revoke unnecessary anonymous access to internal token hashing.
...
revoke execute on function public.hash_network_invite_token(text) from anon;
