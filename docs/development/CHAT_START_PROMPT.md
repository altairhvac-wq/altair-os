...
- [ ] Read `docs/product/ALTair_MASTER_STATUS.md` — current product state
- [ ] Read `docs/product/ALTair_CURRENT_SPRINT.md` — active sprint scope
...
- [ ] If founder/design work: reference `docs/design/ALTAIR_ART_DIRECTION.md` and `docs/product/FOUNDER_MODE.md`
...
- [ ] Check `docs/product/ALTair_BRAIN.md` if unsure whether a module already exists in production
