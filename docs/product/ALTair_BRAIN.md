...
- Connected accounts: Facebook Connect (Pages + Instagram Content Publishing scopes) via OAuth callback + encrypted secrets (service_role); persists linked `instagram_business_account` id per Page; founder Post Now publish actions (Facebook feed/photos + Instagram container flow)
...
**Remaining Work:** Run `docs/reference/internal-alpha-smoke-test.md` on production with real tenant data
...
**Source:** `docs/product/ALTair_V2_ROADMAP.md`
...
- `docs/product/ALTair_MASTER_STATUS.md` — current product state
- `docs/product/ALTair_CURRENT_SPRINT.md` — active sprint scope
- `docs/product/ALTair_V2_ROADMAP.md` — future experience-layer phases
- `docs/reference/internal-alpha-smoke-test.md` — deploy verification checklist
- `docs/archive/architecture/backend-data-map.md` — **outdated planning doc** (pre-Supabase wiring); do not treat as production truth
