...
2. **Deployment checklist sync** — `docs/reference/internal-alpha-deployment-checklist.md` updated for beta-required env vars and migrations `108`/`109`
...
1. **Authenticated production/user-data smoke** — run `docs/reference/internal-alpha-smoke-test.md` against deployed production with real tenant data (operational gate before first HVAC beta company)
...
| Deploy smoke checklist | `docs/reference/internal-alpha-smoke-test.md` |
| Deploy env checklist | `docs/reference/internal-alpha-deployment-checklist.md` |
| North Star flag | `lib/beta/north-star-shell.ts` |
| Session close workflow | `docs/development/SESSION_CLOSE_PROMPT.md` |
