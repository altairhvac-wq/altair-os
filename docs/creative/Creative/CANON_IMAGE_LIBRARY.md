...
| 001 | [ALT-RES-001](./canon/residence/ALT-RES-001.md) | Before Sunrise | Residences | Internal Review |
...
Assets live under `docs/creative/Creative/canon/{category}/`.
...
- Creative execution docs live under `docs/creative/`. The creative-world constitution lives in `docs/foundation/ALTAIR_CANON.md`.
