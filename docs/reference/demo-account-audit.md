...
Related: `docs/marketing/marketing-screenshot-capture-guide.md` (screenshot route list; written for v4 marketing bias — reseed v5 before capture if you need overdue/draft examples).
