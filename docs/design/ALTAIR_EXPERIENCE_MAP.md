...
**Production:** North Star M1–M14 + dispatch shipped behind `NEXT_PUBLIC_NORTH_STAR_SHELL=true`. See `docs/product/ALTair_MASTER_STATUS.md` for phase detail.
...
See `ALTAIR_ART_DIRECTION.md` and Phase 9 in `docs/product/ALTair_V2_ROADMAP.md`.
...
> **Current status detail:** See `docs/product/ALTair_MASTER_STATUS.md`.
