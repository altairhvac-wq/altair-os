...
type TechnicianScheduleContentProps = {
  initialJobId?: string | null;
};

/**
 * Shared server content for the technician day-schedule experience.
 * Rendered by /technician/schedule (the Schedule app tile) and by
 * /technician when a job deep link (?jobId=) is present.
 */
export async function TechnicianScheduleContent({
  initialJobId = null,
}: TechnicianScheduleContentProps) {
