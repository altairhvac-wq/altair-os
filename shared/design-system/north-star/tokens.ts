...
export const northStarTokens: NorthStarDashboardTokens = {
  ...
  heroShell:
    "relative overflow-hidden rounded-[1.5rem] bg-gradient-to-br from-[#181c16]/98 via-[#141813]/96 to-[#10130f]/98 shadow-[0_16px_48px_-16px_rgba(0,0,0,0.48),0_0_0_1px_rgba(255,255,255,0.04)_inset] ring-1 ring-[rgba(194,160,90,0.14)]",
  heroAccentRail:
    "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(194,160,90,0.42)] to-transparent",
  ...
  eyebrowAccent: "text-[10px] font-semibold uppercase tracking-[0.18em] text-[#C2A05A]",
  eyebrowLight:
  ...
  primaryAction:
    "group relative flex w-full flex-col gap-3 overflow-hidden rounded-xl border-l-[3px] border-l-[#C2A05A] bg-gradient-to-br from-[#171b15] via-[#131611] to-[#10130f] p-3.5 text-left shadow-[0_10px_36px_-14px_rgba(0,0,0,0.42)] ring-1 ring-[rgba(194,160,90,0.18)] transition-all hover:border-l-[#C2A05A] hover:ring-[rgba(194,160,90,0.30)] sm:flex-row sm:items-center sm:justify-between sm:p-5",
  ...
  accentBadge:
    "inline-flex items-center rounded-md bg-[rgba(194,160,90,0.18)] px-2 py-0.5 text-[10px] font-bold uppercase tracking-[0.18em] text-[#E8D9AC] ring-1 ring-[rgba(194,160,90,0.32)]",
  accentLine: "h-px bg-gradient-to-r from-transparent via-[rgba(194,160,90,0.35)] to-transparent",
  secondaryAction:
    "group inline-flex items-center gap-2 rounded-lg border border-slate-600/50 bg-slate-800/40 px-3 py-2 transition-all hover:border-[rgba(194,160,90,0.28)] hover:bg-slate-800/60",
  secondaryActionIndex:
    "flex h-5 w-5 items-center justify-center rounded-md bg-slate-700/80 text-[10px] font-bold tabular-nums text-[#C2A05A]",
  insightSurface:
  ...
  opsScoreInline:
    "inline-flex items-center gap-2 rounded-lg border border-[rgba(194,160,90,0.22)] bg-slate-800/40 px-3 py-1.5",
  opsScoreLabel: "text-[10px] font-semibold uppercase tracking-[0.14em] text-[#C2A05A]",
  ...
  opsScoreFill: "h-full rounded-full bg-gradient-to-r from-[#C2A05A] to-[#77591B]",
  opsScoreDivider: "h-4 w-px bg-[rgba(194,160,90,0.28)]",
  liveBadge:
  ...
  primaryActionMetric: "mt-1.5 text-base font-medium tabular-nums text-[#E8D9AC]",

  operatingBoard:
    "relative overflow-hidden rounded-[1.5rem] bg-gradient-to-b from-[#21261e] via-[#1E231B] to-[#1C211A] shadow-[0_14px_48px_-14px_rgba(0,0,0,0.38),0_0_0_1px_rgba(255,255,255,0.06)_inset] ring-1 ring-[rgba(176,168,143,0.22)]",
  boardHeader: "border-b border-white/[0.08] bg-[#1b1f18]/80 px-5 py-4 sm:px-6 sm:py-5",
  boardTopAccent:
  ...
  columnRail:
    "pointer-events-none absolute right-0 top-5 bottom-5 hidden w-px bg-gradient-to-b from-transparent via-[rgba(194,160,90,0.24)] to-transparent lg:block",
  row: "flex items-center gap-3 rounded-lg border border-slate-200/90 bg-[#FCFBF8] px-3.5 py-3 shadow-[0_2px_8px_rgba(0,0,0,0.14)] transition-all hover:border-[rgba(194,160,90,0.32)] hover:shadow-[0_4px_16px_rgba(0,0,0,0.18)]",
  ...
  link: "text-xs font-medium text-[#77591B] transition-colors hover:text-[#77591B]",
  connectionChip:
  ...
  connectionArrow: "h-3 w-3 text-[#77591B]",
  ...
  moneyLeadBorder: "border-l-[#C2A05A]",
  ...
  intelligenceAccent: "text-[#C2A05A]",

  footer:
    "relative overflow-hidden rounded-[1.25rem] bg-gradient-to-b from-[#2E352A] via-[#282e24] to-[#232920] shadow-[0_10px_36px_-12px_rgba(0,0,0,0.32),0_0_0_1px_rgba(255,255,255,0.05)_inset] ring-1 ring-[rgba(176,168,143,0.20)]",
  footerTopAccent:
    "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(194,160,90,0.30)] to-transparent",
  ...
  momentumDot: "mt-1.5 h-1 w-1 shrink-0 rounded-full bg-[#C2A05A]",
  ...
  healthScoreTrack: "rgba(194,160,90,0.22)",
 ...
 *
 * PRESTIGE: this frame was authored as a "moon graphite" palette — cool
 * blue-greys around hue 215 (#273140 / #1A2029 / #AEB6C2 / #DCE3EC / #64748B).
 * That was a second, competing chrome family living beside the warm graphite
 * foundation, and because this module has ~109 importers it carried the cool
 * cast across Leads, Time, Payroll, Expenses and the billing documents.
 *
 * Every value below was shifted onto the warm graphite/parchment band with its
 * WCAG relative luminance held constant, so the frame keeps the exact contrast
 * relationships it was designed with. The names are updated to match.
 *
...
export const northStarListTokens: NorthStarListPageTokens = {
  ...
  pageHeaderEyebrow:
    "text-[10px] font-semibold uppercase tracking-[0.18em] text-[#D9C188]",
  pageHeaderTitle:
    "min-w-0 text-base font-bold tracking-tight text-[#FFF9EA] sm:shrink-0 sm:text-lg lg:font-semibold lg:text-xl",
  pageHeaderSubtitle:
    "min-w-0 text-xs leading-snug text-[#D4CFC2] sm:truncate",
  listSurface:
    "relative lg:rounded-[1.25rem] lg:ring-1 lg:ring-[rgba(124,114,89,0.18)]",
  listSurfaceTopAccent:
    "pointer-events-none absolute inset-x-0 top-0 hidden h-px bg-gradient-to-r from-transparent via-[rgba(176,168,143,0.28)] to-transparent lg:block",
  primaryAction: buttonClassName("primary", "sm", "shrink-0"),
  secondaryAction: buttonClassName("secondary", "sm", "shrink-0"),
  viewTabsBand:
    "shrink-0 border-b border-[rgba(124,114,89,0.18)] bg-[#E5E2DA] px-3 py-2 sm:px-4 lg:px-5",
  viewTabsControl:
    "job-north-star-view-tabs flex w-full gap-0.5 rounded-lg border border-[rgba(176,168,143,0.24)] bg-[#E3DFD6] p-0.5 sm:w-auto",
  viewTabsItem:
  ...
  filterBar:
    "shrink-0 border-b border-[rgba(124,114,89,0.18)] bg-[#E5E2DA] px-3 py-2.5 sm:px-4 lg:px-5 lg:py-3",
  searchInput: [
  ...
  tableRow:
    "cursor-pointer border-b border-[rgba(124,114,89,0.18)] bg-[#FFFFFF] transition-colors hover:bg-[#F6F5F2]",
  tableRowHover: "hover:bg-[#F6F5F2]",
  tableRowSelected:
    "bg-[rgba(194,160,90,0.12)] shadow-[inset_3px_0_0_0_#C2A05A] ring-1 ring-inset ring-[rgba(194,160,90,0.22)]",
  tableCheckbox:
  ...
  badgeDeleted:
    "inline-flex shrink-0 rounded-full bg-[rgba(119,89,27,0.10)] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#77591B] ring-1 ring-[rgba(119,89,27,0.18)]",
  badgeArchived:
...
export const northStarDetailTokens: NorthStarDetailPageTokens = {
  ...
  backLink:
    "inline-flex min-h-11 items-center gap-1.5 text-sm font-medium text-[#D4CFC2] transition-colors hover:text-[#FFF9EA]",
  heroShell: "north-star-detail-hero relative overflow-hidden rounded-xl p-3 sm:p-3.5",
  heroAccentRail:
    "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(217,193,136,0.42)] to-transparent",
  heroEyebrow:
    "text-[10px] font-semibold uppercase tracking-[0.18em] text-[#D9C188]",
  heroTitle: "truncate text-xl font-bold tracking-tight text-[#FFF9EA] sm:text-2xl",
  heroCompany: "mt-0.5 truncate text-sm text-[#D4CFC2]",
  heroMeta: "text-sm text-[#D4CFC2]",
  heroMetaIcon: "h-4 w-4 shrink-0 text-[#77591B]",
  heroAvatar:
    "flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-[#E8D9AC] to-[#A4823A] text-xs font-bold text-[#17130E] ring-1 ring-[rgba(194,160,90,0.28)]",
  heroStatLabel: "text-[10px] font-semibold uppercase tracking-[0.12em] text-[#D4CFC2]",
  heroStatValue: "mt-0.5 text-base font-bold tabular-nums text-[#FFF9EA] sm:text-lg",
  heroLink:
    "text-xs font-semibold text-[#D9C188] transition-colors hover:text-[#E8D9AC]",
  sectionSurface:
  ...
  sectionIconWrap:
    "flex h-9 w-9 shrink-0 items-center justify-center rounded-lg bg-[#EFE4CB] ring-1 ring-[rgba(119,89,27,0.12)] [&_svg]:text-[#77591B]",
  sectionNav:
    "-mx-1 flex gap-1 overflow-x-auto px-1 pb-1 north-star-detail-section-nav",
  sectionNavLink:
    "inline-flex min-h-9 shrink-0 items-center rounded-lg px-2.5 text-xs font-semibold text-[#4F4638] transition-colors hover:bg-[rgba(194,160,90,0.10)] hover:text-[#17130E] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#C2A05A] focus-visible:ring-offset-1",
  primaryAction: buttonClassName("primary", "sm", "shrink-0"),
  secondaryAction: buttonClassName("secondary", "sm", "shrink-0"),
  ...
  tagChip:
    "inline-flex items-center gap-0.5 rounded-full bg-[rgba(194,160,90,0.12)] px-2 py-0.5 text-[11px] font-medium text-[#F3EBDD] ring-1 ring-[rgba(194,160,90,0.22)]",
  link: "text-xs font-semibold text-[#77591B] transition-colors hover:text-[#77591B]",
  emptyState:
    "rounded-xl border border-dashed border-[rgba(119,89,27,0.18)] bg-[#FFF9EA] px-4 py-8 text-center",
  listRowHover:
    "rounded-lg transition-colors hover:bg-[rgba(194,160,90,0.08)] -mx-2 px-2 py-1",
  listDivider: "divide-[rgba(119,89,27,0.12)]",
  notesDetails:
    "group overflow-hidden rounded-[1.25rem] border border-[rgba(119,89,27,0.12)] bg-[#FBF7EF]",
  notesSummary:
  ...
  notesBody: "border-t border-[rgba(119,89,27,0.12)] px-3.5 py-2.5",
  innerCard:
    "rounded-lg border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA] px-2.5 py-2",
  innerCardHover:
    "rounded-md border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA] px-2 py-1.5 transition-colors hover:border-[rgba(194,160,90,0.28)]",
  metricCard:
    "rounded-lg border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA] px-2.5 py-2",
  metricCardHighlight:
  ...
  metricIcon: "h-3.5 w-3.5 shrink-0 text-[#77591B]",
  opportunityLink:
    "inline-flex shrink-0 items-center gap-0.5 text-[11px] font-semibold text-[#77591B]",
  photoCard:
    "w-36 shrink-0 overflow-hidden rounded-xl border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA]",
  photoCardHover:
    "transition-colors hover:border-[rgba(194,160,90,0.35)]",
  bannerDeleted:
  ...
  commandPlate:
    "flex flex-col gap-2 rounded-[1rem] border border-[rgba(119,89,27,0.12)] bg-[#FBF7EF] px-2.5 py-2 sm:flex-row sm:items-center sm:justify-between sm:gap-3 sm:px-3",
  workspaceGrid:
...
export const northStarInvoiceDocumentTokens: NorthStarInvoiceDocumentTokens = {
  ...
  documentCustomerCard:
    "rounded-lg border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA] px-3 py-2 ring-1 ring-[rgba(119,89,27,0.08)] sm:rounded-xl sm:px-4 sm:py-3 print:rounded-none print:border-0 print:bg-white print:px-0 print:py-0 print:ring-0",
  documentLineItemsTable: "invoice-north-star-line-items",
  documentTotalsSurface:
    "rounded-lg border border-[rgba(119,89,27,0.14)] bg-[#FFF9EA] px-3 py-3 sm:rounded-xl sm:px-5 sm:py-4 md:px-6 md:py-5 print:break-inside-avoid print:rounded-none print:border-slate-300 print:bg-white",
  documentTotalLabel:
  ...
  darkLink: "text-[#D9C188] transition-colors hover:text-[#E8D9AC]",
  overlayBodyCanvas:
    "north-star-invoice-overlay-body bg-[#1C211A] print:bg-white",
  overlayHeader:
    "no-print overlay-header-safe-mobile flex shrink-0 items-start gap-2 border-b border-[rgba(194,160,90,0.14)] bg-gradient-to-b from-[#2B3328] to-[#1C211A] px-3 py-2.5 sm:px-4 sm:py-3 lg:pt-3",
...
export const northStarEstimateDocumentTokens: NorthStarEstimateDocumentTokens = {
  ...
  darkLink: "text-[#D9C188] transition-colors hover:text-[#E8D9AC]",
  overlayBodyCanvas:
    "north-star-estimate-overlay-body bg-[#1C211A] print:bg-white",
  overlayHeader:
    "no-print overlay-header-safe-mobile flex shrink-0 items-start gap-2 border-b border-[rgba(194,160,90,0.14)] bg-gradient-to-b from-[#2B3328] to-[#1C211A] px-3 py-2.5 sm:px-4 sm:py-3 lg:pt-3",
  overlayHeaderTitle: "break-words text-base font-bold text-[#FFF8E8] sm:text-lg",
  overlayHeaderSubtitle: "mt-0.5 text-sm text-[#D7CDBD]",
...
export const northStarDispatchTokens: NorthStarDispatchTokens = {
  ...
  boardHeader:
    "flex shrink-0 flex-wrap items-start justify-between gap-2 border-b border-[rgba(194,160,90,0.14)] px-3 py-2.5 sm:px-4 sm:py-3",
  boardHeaderTitle:
    "text-sm font-bold tracking-tight text-[#FFF8E8] sm:text-base",
  boardHeaderSubtitle: "mt-0.5 hidden text-xs text-[#D7CDBD] sm:block",
  boardBody:
    "min-h-0 min-w-0 max-w-full flex-1 overflow-x-hidden overflow-y-auto overscroll-contain bg-[#191d16] px-2 py-2.5 pb-[max(5rem,calc(1rem+env(safe-area-inset-bottom)))] sm:px-3 sm:py-3 sm:pb-16 lg:pb-6",
  boardUnassignedButton:
    "inline-flex min-h-9 shrink-0 items-center gap-1.5 rounded-lg border border-[rgba(194,160,90,0.32)] bg-[rgba(194,160,90,0.12)] px-2.5 py-1.5 text-xs font-semibold text-[#E8D9AC] transition-colors hover:border-[rgba(217,193,136,0.42)] hover:bg-[rgba(194,160,90,0.18)] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(194,160,90,0.35)]",
  ...
  unassignedLaneIcon:
    "flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[rgba(194,160,90,0.18)] text-[#E8D9AC] ring-1 ring-[rgba(194,160,90,0.28)] sm:h-9 sm:w-9 sm:rounded-xl [&_svg]:text-[#E8D9AC]",
  unassignedLaneTitle: "text-sm font-bold text-[#FFF8E8]",
  unassignedLaneSubtitle: "hidden text-[11px] text-[#D7CDBD] sm:block",
  unassignedLaneCount:
    "rounded-full border border-[rgba(194,160,90,0.32)] bg-[rgba(194,160,90,0.16)] px-2 py-0.5 text-[11px] font-bold tabular-nums text-[#E8D9AC]",
  unassignedJobWell:
    "flex min-h-[4.75rem] min-w-0 flex-1 snap-x snap-mandatory gap-2 overflow-x-auto overscroll-x-contain bg-[#191e17] p-2 sm:min-h-[5.5rem] sm:gap-2.5 sm:p-2.5",
  unassignedEmptyWell:
  ...
  jobCardJobNumber:
    "font-semibold uppercase tracking-[0.12em] text-[#D9C188] tabular-nums",
  ...
  detailPanelTopAccent:
    "pointer-events-none absolute inset-x-0 top-0 h-px bg-gradient-to-r from-transparent via-[rgba(217,193,136,0.38)] to-transparent",
  detailPanelHeader:
    "relative flex shrink-0 items-start justify-between border-b border-[rgba(194,160,90,0.14)] bg-gradient-to-b from-[#2B3328] to-[#1C211A] px-4 pb-4 pt-3 overlay-header-safe-mobile sm:px-5 lg:py-4",
  detailPanelTitle:
  ...
  detailTechPhone: "text-xs text-[#D7CDBD] [&_svg]:text-[#D9C188]",
  detailUnassignedBanner:
    "flex items-center gap-2 text-sm font-medium text-[#E8D9AC]",
  detailEstimateHint:
    "rounded-lg border border-[rgba(194,160,90,0.28)] bg-[rgba(194,160,90,0.12)] px-3 py-2.5 text-xs font-medium text-[#E8D9AC] ring-1 ring-[rgba(194,160,90,0.16)]",
  detailSelect:
    "w-full min-h-11 rounded-lg border border-[rgba(176,168,143,0.24)] bg-[#FFFFFF] px-3 py-3 text-sm text-[#151914] outline-none focus:border-[#A4823A] focus:ring-2 focus:ring-[rgba(194,160,90,0.22)] disabled:cursor-not-allowed disabled:opacity-60 sm:py-2",
  ...
  sectionSheetHeaderIcon:
    "bg-[rgba(194,160,90,0.14)] text-[#D9C188] ring-1 ring-[rgba(194,160,90,0.22)] sm:rounded-xl [&_svg]:text-[#D9C188]",
  sectionSheetBody:
    "min-w-0 overflow-x-hidden bg-[#191d16] pb-[max(5.5rem,calc(1.25rem+env(safe-area-inset-bottom)))] sm:pb-[max(4rem,calc(1rem+env(safe-area-inset-bottom)))]",
  ...
  unassignedSheetPanel:
    "dispatch-north-star-unassigned-sheet relative flex h-[90dvh] max-h-[90dvh] min-h-0 flex-col overflow-hidden rounded-t-2xl border border-[rgba(194,160,90,0.28)] bg-[#1C211A] shadow-[0_14px_48px_-14px_rgba(0,0,0,0.38)] sm:h-auto sm:max-h-[80vh] sm:rounded-2xl",
  unassignedSheetHeader:
    "border-b border-[rgba(194,160,90,0.18)] bg-gradient-to-b from-[#2B3328] to-[#1C211A]",
  unassignedSheetHeaderIcon:
    "bg-[rgba(194,160,90,0.18)] text-[#E8D9AC] ring-1 ring-[rgba(194,160,90,0.28)] sm:rounded-xl [&_svg]:text-[#E8D9AC]",
  ...
  summaryMetricDescription: "mt-0.5 hidden text-xs text-[#BCB5A5] sm:block",
  summaryMetricIcon:
