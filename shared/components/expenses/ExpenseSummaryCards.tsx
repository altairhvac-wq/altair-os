  ...
  return (
    ...
    >
      {cards.map((card) => (
        <div
          key={card.label}
          className="rounded-[1rem] border border-[rgba(119,89,27,0.12)] bg-[#FBF7EF] px-3 py-2.5 shadow-[0_2px_8px_rgba(3,7,12,0.08)] sm:px-3.5 sm:py-3"
        >
          <div className="flex items-start justify-between gap-2">
            ...
            <div
              className={`flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#EFE4CB] ring-1 ring-[rgba(119,89,27,0.12)] sm:h-9 sm:w-9 ${card.northStarIconClassName ?? ""}`}
            >
  ...
  const cards: SummaryCard[] = [
    {
      ...
      northStarIconClassName: "text-[#77591B]",
    },
    {
      label: "Approved",
    ...
    },
    {
      ...
      northStarIconClassName: "text-[#736850]",
    },
    {
      label: "Total Spent",
