        ...
        <form onSubmit={handleRejectSubmit} className="space-y-3">
          <div>
            ...
            >
              ...
              <span
                className={`font-normal ${
                  northStar ? "text-[#7C7259]" : "text-slate-400"
                }`}
              >
                (optional)
              </span>
            ...
            <textarea
              ...
              className={
                northStar
                  ? "w-full rounded-lg border border-[rgba(119,89,27,0.18)] bg-[#FFF9EA] px-3 py-2.5 text-sm text-[#17130E] outline-none transition-colors placeholder:text-[#7C7259] focus:border-[#A4823A] focus:bg-[#FBF7EF] focus:ring-2 focus:ring-[rgba(194,160,90,0.22)]"
