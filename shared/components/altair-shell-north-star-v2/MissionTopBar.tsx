  ...
  return (
    <header className={missionTopBarClass}>
      <div className="flex min-w-0 items-center gap-3">
        <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-gradient-to-br from-cyan-500 to-blue-600 text-xs font-bold text-white lg:hidden">
          A
        </div>
      ...
      <div className="flex items-center gap-2 sm:gap-3">
        <button
          type="button"
          className="relative flex h-9 w-9 items-center justify-center rounded-xl bg-slate-800/50 text-slate-400 ring-1 ring-slate-700/40 transition-all hover:bg-slate-800/70 hover:text-slate-200 hover:ring-slate-600/45"
        ...
        <button
          type="button"
          className="flex items-center gap-2 rounded-xl bg-slate-800/50 py-1.5 pl-1.5 pr-3 ring-1 ring-slate-700/40 transition-all hover:bg-slate-800/70 hover:ring-slate-600/45"
        >
          <span className="flex h-7 w-7 items-center justify-center rounded-lg bg-gradient-to-br from-blue-500 to-blue-700 text-[10px] font-semibold text-white">
            {userInitials}
          </span>
