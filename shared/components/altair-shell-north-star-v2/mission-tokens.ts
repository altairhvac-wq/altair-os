...
export const missionRootClass = "bg-[#10130f]";

export const missionTopBarClass =
  "flex shrink-0 items-center justify-between gap-4 border-b border-slate-800/60 bg-[#10130f]/95 px-4 py-3 backdrop-blur-2xl sm:px-6";
...
export const missionCanvasGlowPrimaryClass =
  "pointer-events-none absolute inset-x-0 top-0 h-48 bg-[radial-gradient(ellipse_70%_80%_at_50%_0%,rgba(176,168,143,0.14),transparent_72%)]";

export const missionCanvasGlowSecondaryClass =
  "pointer-events-none absolute right-0 top-0 h-40 w-48 bg-[radial-gradient(circle_at_100%_0%,rgba(124,114,89,0.08),transparent_70%)]";

export const missionCanvasGlowAccentClass =
  "pointer-events-none absolute bottom-0 left-0 h-40 w-64 bg-[radial-gradient(circle_at_0%_100%,rgba(176,168,143,0.06),transparent_72%)]";

/* ── Hero (dark command anchor) ───────────────────────────────── */

export const missionHeroClass =
  "relative overflow-hidden rounded-[2rem] bg-gradient-to-br from-[#181c16]/98 via-[#141813]/96 to-[#10130f]/98 p-5 shadow-[0_24px_80px_-24px_rgba(0,0,0,0.55),0_0_0_1px_rgba(255,255,255,0.04)_inset] ring-1 ring-slate-700/30 backdrop-blur-xl sm:p-6 lg:p-8";
...
export const missionBoardHeaderClass =
  "border-b border-slate-700/25 bg-gradient-to-r from-[#181c16] via-[#151813] to-[#181c16] px-4 py-4 sm:px-6 sm:py-5";
