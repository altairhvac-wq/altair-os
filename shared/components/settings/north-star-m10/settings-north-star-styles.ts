...
export const settingsNorthStarStyles = {
  ...
  sectionSubtitle: "mt-0.5 text-[11px] leading-snug text-[#6B6255]",
  summaryCard:
  ...
  systemCheckDescription: "text-xs leading-snug text-[#6B6255] sm:text-sm",
  systemCheckBadge:
    "shrink-0 text-[10px] font-semibold uppercase tracking-[0.12em] text-[#8A6324]",
  statusChipCurrent:
    "inline-flex items-center rounded-full bg-[rgba(138,99,36,0.07)] px-2 py-0.5 text-[10px] font-medium uppercase tracking-[0.08em] text-[#6B6255] ring-1 ring-[rgba(138,99,36,0.12)]",
  statusChipReview:
  ...
  formInput:
    "w-full min-h-10 rounded-lg border border-[rgba(138,99,36,0.18)] bg-[#FFF9EA] px-3 py-2 text-sm text-[#17130E] placeholder:text-[#6B6255] outline-none transition-colors focus:border-[#B88A2E] focus:bg-[#FBF7EF] focus:ring-2 focus:ring-[rgba(201,164,77,0.22)] sm:min-h-[44px] sm:py-2.5",
  formTextarea:
    "w-full min-h-[80px] max-w-full resize-y rounded-lg border border-[rgba(138,99,36,0.18)] bg-[#FFF9EA] px-3 py-2 text-sm text-[#17130E] placeholder:text-[#6B6255] outline-none transition-colors focus:border-[#B88A2E] focus:bg-[#FBF7EF] focus:ring-2 focus:ring-[rgba(201,164,77,0.22)] sm:min-h-[96px] sm:py-2.5",
