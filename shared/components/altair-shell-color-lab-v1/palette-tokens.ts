...
export const missionControlRefined: PaletteTokens = {
  ...
  intent:
    "Dark graphite shell, navy command hero, brass accents with restrained field-ops signal — premium trades OS energy.",
  heroMode: "dark",
  ...
  sidebarLogoRing: "ring-1 ring-[rgba(198,167,87,0.32)]",
  sidebarActiveIcon: "text-[#C6A757]",
  sidebarActiveRing: "ring-1 ring-[rgba(198,167,87,0.25)]",
