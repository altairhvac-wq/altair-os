...
export function InvoicePaymentCollectionCard({
  ...
  const sectionClass = fieldVariant
  ...
  const primaryButtonClass = northStar
    ? `${buttonClassName("primary", "sm", "shrink-0")} disabled:cursor-not-allowed disabled:opacity-60`
    : fieldVariant
  ...
  const secondaryButtonClass = northStar
    ? `${buttonClassName("secondary", "sm", "shrink-0")} disabled:cursor-not-allowed disabled:opacity-60`
    : fieldVariant
  ...
  const disabledSecondaryButtonClass = northStar
    ? `${buttonClassName("secondary", "sm", "shrink-0")} cursor-not-allowed opacity-50`
    : fieldVariant
  ...
  const collectionInner = !onlinePaymentsEnabled ? (
    <div className="flex items-start gap-3">
      <Link2
        className={`mt-0.5 h-4 w-4 shrink-0 ${northStar ? "text-altair-brass" : "text-slate-400"}`}
        aria-hidden
      />
      <div className="min-w-0 flex-1">
        {northStar ? null : <h2 className={titleClass}>Collect payment</h2>}
        <p className={`${northStar ? "" : "mt-2 "}${bodyClass}`}>
    ...
    <div className="flex items-start gap-3">
      <Link2
        className={`mt-0.5 h-4 w-4 shrink-0 ${northStar ? "text-altair-brass" : "text-emerald-600"}`}
        aria-hidden
      />
      <div className="min-w-0 flex-1">
        {northStar ? null : <h2 className={titleClass}>Collect payment</h2>}
        ...
        {paymentUrl ? (
          <div className="mt-4 flex flex-col items-center gap-4 sm:flex-row sm:items-start">
            ...
            <div className="min-w-0 flex-1 space-y-3">
              ...
              <div
                className={`flex flex-col gap-2 ${fieldVariant ? "" : "sm:flex-row sm:flex-wrap"}`}
              >
                <button
                  type="button"
        ...
        <div
          className={`mt-4 flex flex-col gap-2 ${fieldVariant ? "" : "sm:flex-row sm:flex-wrap"}`}
        >
          <button
            type="button"
  ...
  return <section className={sectionClass}>{collectionInner}</section>;
}
