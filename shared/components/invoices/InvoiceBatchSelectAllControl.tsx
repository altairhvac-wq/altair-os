...
export function InvoiceBatchSelectAllControl({
  ...
  const clearClass = northStar
    ? "inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg border border-[rgba(119,89,27,0.22)] bg-[#FFF9EA] px-2.5 py-1.5 text-xs font-semibold text-[#4F4638] transition-colors hover:border-[#C2A05A] hover:bg-[#F3EBDD] md:min-h-9"
  ...
  const checkAllClass = northStar
    ? "inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg border border-[#D9C188] bg-[#EFE4CB] px-2.5 py-1.5 text-xs font-semibold text-[#17130E] transition-colors hover:border-[#E8D9AC] hover:bg-[#F3EBDD] md:min-h-9"
