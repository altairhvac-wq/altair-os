...
export function DispatchSearchFilterBar({
  ...
  const searchInputClass = northStar
    ? lt.searchInput
    : "h-11 min-h-11 w-full rounded-xl border border-altair-border bg-altair-paper-elevated py-2.5 pl-10 pr-3 text-sm text-altair-ink-on-paper placeholder:text-altair-ink-on-paper-muted outline-none transition-colors hover:border-altair-border-strong focus-visible:border-altair-border-strong focus-visible:ring-2 focus-visible:ring-altair-ink-on-paper focus-visible:ring-offset-2 focus-visible:ring-offset-altair-paper-elevated md:h-10 md:min-h-10 sm:pl-10";

  const filterSelectClass = northStar
    ? lt.filterSelect
    : "h-11 min-h-11 appearance-none rounded-xl border border-altair-border bg-altair-paper-elevated py-2.5 pl-10 pr-10 text-sm font-medium text-altair-ink-on-paper outline-none transition-colors hover:border-altair-border-strong focus-visible:border-altair-border-strong focus-visible:ring-2 focus-visible:ring-altair-ink-on-paper focus-visible:ring-offset-2 focus-visible:ring-offset-altair-paper-elevated md:h-10 md:min-h-10 w-full sm:w-auto sm:pl-10 sm:pr-10";
