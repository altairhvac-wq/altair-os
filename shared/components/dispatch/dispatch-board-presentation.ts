...
export const dispatchMissionClasses = {
  ...
  boardHeaderSubtitle:
    "mt-0.5 hidden text-xs text-altair-ink-on-graphite-muted sm:block",
  ...
  laneHeaderNextJob:
    "hidden text-[9px] font-medium leading-none text-altair-ink-on-graphite-muted xl:inline",
  laneHeaderCount:
  ...
  laneEmptyText: "text-[10px] font-medium text-altair-ink-on-graphite-muted sm:text-[11px]",
  laneEmptyOverlay:
    "pointer-events-none absolute inset-y-0 left-4 z-[5] flex items-center px-1",
  laneEmptyPill:
    "rounded-md border border-dashed border-altair-border/70 bg-altair-graphite/80 px-2 py-0.5 text-center text-[9px] font-medium text-altair-ink-on-graphite-muted",
  ...
  headerSubtitle: "min-w-0 text-xs leading-snug text-altair-ink-on-graphite-muted sm:truncate",
  ...
  mapStatus:
    "absolute inset-x-0 bottom-0 z-10 border-t border-altair-border/70 bg-altair-graphite/90 px-3 py-2 text-[11px] text-altair-ink-on-graphite-muted backdrop-blur-sm sm:text-xs",
  mapEmpty:
