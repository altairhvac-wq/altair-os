...
export const teamMemberNorthStarStyles = {
  ...
  metaRow: "flex flex-wrap items-start justify-between gap-x-4 gap-y-1 border-b border-[rgba(119,89,27,0.08)] py-2.5 last:border-b-0",
  ...
  listRow:
    "flex min-h-11 items-start gap-2 rounded-lg px-1 py-2 transition-colors hover:bg-[rgba(194,160,90,0.08)]",
  activityType:
  ...
  bannerSuspended:
    "rounded-lg border border-[rgba(119,89,27,0.18)] bg-[#F5F0E4] px-3 py-2 text-sm text-[#4F4638]",
  statusActive:
  ...
  statusSuspended:
    "inline-flex items-center rounded-full bg-[rgba(119,89,27,0.08)] px-2.5 py-0.5 text-xs font-medium text-[#4F4638] ring-1 ring-[rgba(119,89,27,0.14)]",
