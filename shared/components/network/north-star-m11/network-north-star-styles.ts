...
export const networkNorthStarStyles = {
  ...
  sectionEyebrow:
    "text-[10px] font-semibold uppercase tracking-[0.14em] text-[#77591B]",
  sectionTitle: "text-sm font-bold text-[#17130E]",
  sectionSubtitle: "text-[11px] leading-snug text-[#4F4638]",
  panelHeader:
    "shrink-0 border-b border-[rgba(119,89,27,0.12)] bg-[#F5F0E4] px-3 py-2.5 sm:px-4 lg:px-5",
  scrollRegion: "flex-1 overflow-y-auto overscroll-contain",
  tabBand: lt.viewTabsBand,
  tabControl:
    "job-north-star-view-tabs grid w-full grid-cols-2 gap-0.5 rounded-lg border border-[rgba(176,168,143,0.24)] bg-[#E3DFD6] p-0.5 min-[420px]:grid-cols-3 sm:flex sm:w-auto",
  tabItem: lt.viewTabsItem,
  tabItemActive: lt.viewTabsItemActive,
  tabAttentionBadge:
    "ml-1.5 inline-flex h-1.5 w-1.5 shrink-0 rounded-full bg-[#A4823A] ring-2 ring-[#FBF7EF]",
  ...
  filterToolbar: "shrink-0 border-b border-[rgba(119,89,27,0.08)] pb-3",
  filterToolbarRow:
  ...
  panelActionAccent:
    "inline-flex min-h-8 shrink-0 items-center gap-1.5 rounded-lg border border-[rgba(194,160,90,0.42)] bg-gradient-to-b from-[#F0E4B8] from-0% via-[#D4B05A] via-[50%] to-[#C2A05A] to-100% px-2.5 py-1.5 text-xs font-semibold text-[#17130E] shadow-[0_1px_4px_rgba(119,89,27,0.12)] transition-all hover:from-[#F5EBC8] hover:via-[#DDB868] hover:to-[#A4823A] disabled:cursor-not-allowed disabled:opacity-60 [&_svg]:text-[#17130E]",
  cardShellTrusted:
  ...
  detailPanel:
    "flex min-w-0 shrink-0 flex-col overflow-hidden rounded-lg border border-[rgba(119,89,27,0.10)] bg-[#FBF7EF]/80 lg:max-h-[min(40rem,70vh)]",
  detailPanelHeader:
    "flex shrink-0 items-start justify-between border-b border-[rgba(119,89,27,0.12)] bg-[#F5F0E4] px-3 py-2.5 sm:px-4",
  ...
  detailPanelProfileHero:
    "rounded-xl border border-[rgba(119,89,27,0.12)] bg-[#FFF9EA] p-4 shadow-[0_2px_12px_rgba(119,89,27,0.08)]",
  ...
  commandHeaderChip:
    "inline-flex items-center rounded-full border border-[rgba(119,89,27,0.14)] bg-[#FFF9EA] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-[#4F4638]",
  commandHeaderChipAccent:
    "inline-flex items-center rounded-full border border-[rgba(194,160,90,0.28)] bg-[rgba(194,160,90,0.10)] px-2.5 py-0.5 text-[10px] font-semibold uppercase tracking-[0.08em] text-[#77591B]",
  tabBodySurface:
    "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-[1.25rem] border border-[rgba(119,89,27,0.10)] bg-[#FBF7EF]",
  tabBodyInner:
  ...
  flatPanelHeader:
    "shrink-0 space-y-2 border-b border-[rgba(119,89,27,0.08)] pb-3",
  ...
  mapPreviewPanel:
    "relative flex min-h-[7rem] max-h-[8.5rem] flex-col overflow-hidden rounded-lg border border-[rgba(119,89,27,0.12)] bg-[#EDE6D4] shadow-[inset_0_1px_0_rgba(255,255,255,0.45)] sm:min-h-[7.5rem]",
  mapPreviewCanvas:
    "pointer-events-none absolute inset-0 overflow-hidden",
  mapPreviewGrid:
    "absolute inset-0 bg-[linear-gradient(rgba(119,89,27,0.07)_1px,transparent_1px),linear-gradient(90deg,rgba(119,89,27,0.07)_1px,transparent_1px)] bg-[size:28px_28px] [mask-image:radial-gradient(ellipse_80%_70%_at_50%_45%,black_15%,transparent_72%)]",
  mapPreviewRoads:
    "absolute inset-0 opacity-60 [background:repeating-linear-gradient(118deg,transparent,transparent_38px,rgba(119,89,27,0.05)_38px,rgba(119,89,27,0.05)_39px),repeating-linear-gradient(28deg,transparent,transparent_52px,rgba(194,160,90,0.06)_52px,rgba(194,160,90,0.06)_53px)]",
  mapPreviewGlow:
    "absolute left-1/2 top-[42%] h-[70%] w-[85%] -translate-x-1/2 -translate-y-1/2 rounded-full bg-[radial-gradient(ellipse_at_center,rgba(194,160,90,0.18)_0%,rgba(194,160,90,0.06)_42%,transparent_72%)]",
  mapPreviewRing:
    "absolute left-1/2 top-[42%] -translate-x-1/2 -translate-y-1/2 rounded-full border border-[rgba(194,160,90,0.14)]",
  mapPreviewRingOuter: "h-[min(58%,5.5rem)] w-[min(58%,5.5rem)]",
  mapPreviewRingInner:
    "h-[min(38%,3.5rem)] w-[min(38%,3.5rem)] border-[rgba(194,160,90,0.10)]",
  mapPreviewContent:
    "relative z-[1] flex flex-1 flex-col justify-between px-3 py-2 sm:px-3 sm:py-2",
  mapPreviewHeader: "flex items-start gap-2",
  mapPreviewIcon:
    "flex h-7 w-7 shrink-0 items-center justify-center rounded-lg bg-[#FFF9EA] text-[#77591B] shadow-[0_1px_4px_rgba(119,89,27,0.10)] ring-1 ring-[rgba(119,89,27,0.12)]",
  ...
  cardShellSelected:
    "group/card relative rounded-lg border border-[rgba(194,160,90,0.45)] bg-[#FFF9EA] px-2 py-1.5 shadow-[0_1px_6px_rgba(119,89,27,0.08)] ring-1 ring-[rgba(194,160,90,0.28)] transition-colors",
  rosterRowChevron:
    "ml-1 shrink-0 self-center text-[#77591B] opacity-0 transition-all group-hover/card:opacity-70 group-data-[selected=true]/card:opacity-100",
  rosterRowChevronActive: "translate-x-0.5 opacity-100 text-[#77591B]",
  rosterList: "flex min-w-0 flex-col gap-0.5 divide-y divide-[rgba(119,89,27,0.06)]",
  rosterListMyNetwork: "flex min-w-0 flex-col gap-0.5 divide-y divide-[rgba(119,89,27,0.06)]",
  rosterSectionHeader: "flex shrink-0 items-baseline justify-between gap-2 pb-1",
  emptyStateStrong: "rounded-xl border border-[rgba(119,89,27,0.10)] bg-[#FFF9EA]/60 px-4 py-8 text-center sm:py-9",
