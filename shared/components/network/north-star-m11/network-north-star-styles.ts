...
export const networkNorthStarStyles = {
  ...
  tabControl:
    "job-north-star-view-tabs grid w-full grid-cols-2 gap-0.5 rounded-lg border border-[rgba(148,163,184,0.24)] bg-[#D8E0EA] p-0.5 min-[420px]:grid-cols-3 sm:flex sm:w-auto",
