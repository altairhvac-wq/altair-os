...
export function SubcontractJobDetailsPanel({
  ...
  return (
    <aside
      className={`${listDetailPanelClass(Boolean(job))} min-h-[12rem] min-w-0 flex-[1_1_45%] flex-col overflow-hidden admin-card lg:h-full lg:min-h-0 lg:w-[400px] lg:flex-none lg:shrink-0`}
    >
