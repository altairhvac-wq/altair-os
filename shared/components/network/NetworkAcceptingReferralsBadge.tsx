...
export function NetworkAcceptingReferralsBadge({
  ...
  if (accepting) {
    const badgeClass =
      surface === "north-star"
        ? "inline-flex items-center gap-1 rounded-full bg-[rgba(145,132,101,0.08)] px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wide text-[#635A45] ring-1 ring-[rgba(145,132,101,0.18)]"
