...
const northStarActionClass =
  "inline-flex min-h-11 flex-1 items-center justify-center gap-1.5 rounded-lg border border-[rgba(119,89,27,0.18)] bg-[#FFF9EA] px-2.5 py-2 text-sm font-semibold text-[#4F4638] transition-colors hover:border-[#C2A05A] hover:bg-[#F3EBDD] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[rgba(194,160,90,0.30)]";
