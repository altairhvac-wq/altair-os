...
function PreviewShell({
  ...
  return (
    <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-white/[0.1] bg-[#111410] shadow-[0_18px_45px_-28px_rgba(0,0,0,0.9)]">
      <div className="flex items-start gap-3 border-b border-white/[0.07] px-4 py-3.5">
        <span className="mt-0.5 flex h-8 w-8 shrink-0 items-center justify-center rounded-lg border border-[#c2a05a]/20 bg-[#10120e] text-[#e0b84f]">
      ...
      <div
        className="min-h-[236px] flex-1 overflow-hidden bg-[#eeece7] p-3.5"
        aria-hidden="true"
      >
        {children}
      </div>
...
function DashboardPreview() {
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden rounded-xl border border-[#2A3127]/15 bg-white shadow-sm">
        <div className="flex items-center justify-between bg-[#171b15] px-3.5 py-3 text-white">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.14em] text-[#e8d9ac]">
              Operating center
            </p>
        ...
        <div className="grid grid-cols-3 gap-2 bg-[#e5e2da] p-3">
          {metrics.map((metric) => (
...
function DispatchPreview() {
  return (
    <PreviewShell
      ...
      icon={Radio}
    >
      <div className="h-full rounded-xl border border-[#2A3127] bg-[#121510] p-3.5 shadow-sm">
        <div className="flex items-center justify-between border-b border-white/[0.08] pb-3">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-full border border-[#e8d9ac]/20 bg-[#77591b] text-[10px] font-semibold text-white">
              FT
            </span>
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-[0.13em] text-[#e8d9ac]">
                Assigned technician
              </p>
              <p className="mt-1 text-xs text-slate-300">Today’s field lane</p>
            </div>
          </div>
          <CalendarDays className="h-4 w-4 text-[#c2a05a]" />
        </div>
        <div className="mt-3 space-y-2">
          {DISPATCH_JOBS.map((job) => (
            <div key={job.id} className="grid grid-cols-[3.4rem_1fr_auto] items-center gap-2 rounded-lg border border-white/[0.07] bg-[#171b15] p-2.5">
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden rounded-xl border border-slate-200 bg-white shadow-sm">
        <div className="flex items-center justify-between bg-[#e5e2da] px-3.5 py-3">
          <div>
          ...
          <span className="rounded-full bg-[#fff3d6] px-2 py-1 text-[10px] font-semibold text-[#77591b]">
            Partially paid
          </span>
        </div>
        ...
        <div className="px-3.5 py-3">
          ...
          <div className="mt-2 h-2 overflow-hidden rounded-full bg-slate-100">
            <div className="h-full w-[49%] rounded-full bg-[#a4823a]" />
          </div>
  ...
  return (
    ...
    >
      <div className="h-full overflow-hidden rounded-xl border border-[#d8ccb4] bg-[#fffaf0] shadow-sm">
        <div className="flex items-center gap-3 bg-[#171b15] px-3.5 py-3 text-white">
          <span className="flex h-10 w-10 items-center justify-center rounded-full border border-[#e8d9ac]/30 bg-[#77591b] text-xs font-semibold">
            LA
          </span>
        ...
        <div className="grid grid-cols-2 gap-2 p-3">
          <div className="rounded-lg border border-[#e8d9ac] bg-white p-3">
          ...
          <div className="col-span-2 flex items-center justify-between rounded-lg border border-[#e8d9ac] bg-white px-3 py-2.5">
    ...
    >
      <div className="flex h-full flex-col overflow-hidden rounded-xl border border-[#d8ccb4] bg-[#fffaf0] shadow-sm">
        <div className="flex items-center justify-between border-b border-[#e6dcc8] px-3.5 py-3">
          <div>
            <p className="text-[10px] font-semibold uppercase tracking-[0.13em] text-[#77591b]">
              Operating brief
            </p>
            <p className="mt-1 text-xs font-semibold text-slate-950">Last 30 days</p>
          </div>
          <BarChart3 className="h-4 w-4 text-[#77591b]" />
        </div>
        ...
        <div className="mt-auto px-4 pb-4 pt-3">
          ...
          <div className="mt-2 flex items-center gap-4 text-[10px] text-slate-500">
            ...
            <span className="flex items-center gap-1.5">
              <span className="h-2 w-2 rounded-full bg-[#a4823a]" />
              Outstanding $5,514
            </span>
          </div>
        </div>
