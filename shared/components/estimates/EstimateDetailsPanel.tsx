...
export function EstimateDetailsPanel({
  ...
  const createPanelBodyClass =
    "flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden px-3 py-2.5";

  return (
    <aside
      className={`${listDetailPanelClass(mode !== "empty")} flex min-h-0 min-w-0 flex-[1_1_45%] flex-col overflow-hidden admin-card ${
        mode === "create" ? "max-lg:min-h-0 max-lg:flex-1" : "max-lg:min-h-[12rem]"
      } lg:h-full lg:w-[400px] lg:flex-none lg:shrink-0`}
    >
      ...
      <div className={mode === "create" ? createPanelBodyClass : adminPanelBodyClass}>
        {mode === "empty" ? (
