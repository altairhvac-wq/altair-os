  ...
  return (
    <ModalPortal>
      ...
      >
        ...
        />
        <div className="relative z-10 flex max-h-[92vh] w-full max-w-5xl flex-col overflow-hidden rounded-t-2xl border border-[#C2A05A]/28 bg-[#0A0A0A] shadow-[0_24px_64px_rgba(0,0,0,0.55),0_8px_24px_rgba(194,160,90,0.12)] sm:max-h-[90vh] sm:rounded-2xl">
          <header className="flex shrink-0 items-center gap-3 border-b border-[#C2A05A]/16 px-4 py-3">
            <h2
              id={titleId}
            ...
            <button
              ...
              onClick={onClose}
              aria-label="Close"
              className="flex h-9 w-9 shrink-0 items-center justify-center rounded-lg border border-[#C2A05A]/22 text-neutral-400 transition-colors hover:border-[#C2A05A]/38 hover:bg-[#C2A05A]/8 hover:text-[#C2A05A]"
            >
...
export function ProductScreenshotPlaceholder({
  ...
  const frameClass = [
    "group/image relative overflow-hidden rounded-xl border border-[#C2A05A]/22 bg-[#0A0A0A] shadow-[0_14px_44px_rgba(0,0,0,0.42),0_4px_14px_rgba(0,0,0,0.28),inset_0_1px_0_rgba(245,230,163,0.12)] motion-safe:transition-[border-color,box-shadow] motion-safe:duration-300 motion-safe:hover:border-[#C2A05A]/38 motion-safe:hover:shadow-[0_18px_52px_rgba(0,0,0,0.48),0_6px_20px_rgba(194,160,90,0.12),inset_0_1px_0_rgba(245,230,163,0.16)]",
    className,
  ].join(" ");
    ...
    return (
      <>
        ...
        >
          ...
          <span className="pointer-events-none absolute bottom-2 right-2 inline-flex items-center gap-1 rounded-full border border-[#C2A05A]/28 bg-[#0A0A0A]/85 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-[0.1em] text-[#C2A05A]/90 shadow-sm motion-safe:transition-opacity motion-safe:duration-200 sm:bottom-2.5 sm:right-2.5 sm:px-2.5 sm:py-1 sm:text-[11px]">
  ...
  return (
    <div className={frameClass} role="img" aria-label={alt}>
      ...
      <div className="pointer-events-none absolute inset-0 bg-[radial-gradient(ellipse_80%_70%_at_50%_35%,rgba(194,160,90,0.08)_0%,transparent_65%)]" />

      <div className="relative flex aspect-[16/9] w-full flex-col">
        <div className="flex items-center gap-2 border-b border-[#C2A05A]/12 px-3 py-2 sm:px-4">
          <span className="h-2 w-2 rounded-full bg-[#C2A05A]/35" aria-hidden="true" />
          <span className="h-2 w-2 rounded-full bg-[#C2A05A]/22" aria-hidden="true" />
          <span className="h-2 w-2 rounded-full bg-[#C2A05A]/14" aria-hidden="true" />
        ...
        <div className="flex flex-1 flex-col items-center justify-center gap-3 px-4 py-6 sm:gap-4 sm:px-6">
          <div className="flex h-10 w-10 items-center justify-center rounded-lg border border-[#C2A05A]/24 bg-[#C2A05A]/8 sm:h-12 sm:w-12">
            <svg
              viewBox="0 0 24 24"
              fill="none"
              className="h-5 w-5 text-[#C2A05A]/70 sm:h-6 sm:w-6"
              aria-hidden="true"
            >
              <rect
                x="3"
          ...
          <p className="text-center text-[11px] font-semibold uppercase tracking-[0.14em] text-[#C2A05A]/75 sm:text-xs">
