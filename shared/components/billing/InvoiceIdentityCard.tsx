...
export function InvoiceIdentityCard({
  ...
  return (
    <div className="invoice-identity-card rounded-xl border border-slate-200 bg-white px-5 py-5 ring-1 ring-slate-100 sm:px-6 sm:py-6 print:rounded-none print:border-slate-300 print:bg-white print:px-0 print:py-0 print:ring-0">
