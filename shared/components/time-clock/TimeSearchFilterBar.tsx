...
type TimeSearchFilterBarProps = {
  ...
  onStatusFilterChange: (value: TimeEntryStatus | "all") => void;
  resultCount: number;
};
  ...
  return (
    <div className="border-b border-slate-100 px-4 py-3">
      <div className="flex flex-col gap-3 lg:flex-row lg:items-center">
        <div className="relative flex-1">
          ...
          <input
            ...
            placeholder="Search by technician, job, status, or notes..."
        ...
        <div className="relative shrink-0">
          ...
          <select
            value={statusFilter}
            onChange={(e) =>
              onStatusFilterChange(e.target.value as TimeEntryStatus | "all")
            }
      ...
      <p className="mt-2 text-xs text-slate-500">
        {resultCount} {resultCount === 1 ? "time entry" : "time entries"}
      </p>
    </div>
  );
}
