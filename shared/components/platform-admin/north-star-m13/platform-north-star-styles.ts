...
export const platformNorthStarStyles = {
  ...
  noticeShell:
    "rounded-[1rem] border border-[rgba(119,89,27,0.16)] bg-[#FBF7EF] px-3.5 py-3 sm:px-4",
  noticeTitle: "text-sm font-semibold text-[#17130E]",
  noticeBody: "mt-0.5 text-xs leading-snug text-[#4F4638]",
  noticeIcon: "mt-0.5 h-4 w-4 shrink-0 text-[#77591B]",
  diagnosticsShell:
  ...
  listDivider: "divide-y divide-[rgba(119,89,27,0.12)]",
  tableWrap: "overflow-x-auto",
  tableHead: lt.tableHeaderRow,
  tableHeadCell: "whitespace-nowrap px-3 py-2",
  tableBody: "divide-y divide-[rgba(119,89,27,0.12)] bg-[#FBF7EF]",
  ...
  tableLink:
    "text-xs font-semibold text-[#77591B] transition-colors hover:text-[#77591B] hover:underline",
  ...
  subNavBand:
    "platform-north-star-subnav shrink-0 border-b border-[rgba(119,89,27,0.12)] bg-[#F5F0E4] px-3 py-2 sm:px-3.5 lg:px-5",
  subNavControl:
    "flex w-full flex-wrap gap-1 rounded-lg border border-[rgba(119,89,27,0.18)] bg-[#EFE4CB] p-0.5 sm:w-auto",
  subNavItem:
