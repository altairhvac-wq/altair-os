/**
 * Capture owner mission-briefing dashboard screenshots (Phase 1 IA).
...
const SHOTS = [
  { name: "01-mobile-390.png", width: 390, height: 844, fullPage: true },
  { name: "02-mobile-360.png", width: 360, height: 800, fullPage: true },
  { name: "03-desktop.png", width: 1440, height: 1000, fullPage: true },
];

const SECTION_SHOTS = [
  { name: "04-needs-attention.png", title: "Needs Attention" },
  { name: "05-todays-brief.png", title: "Today's Brief" },
  { name: "06-business-health.png", title: "Business Health" },
  { name: "07-recent-activity.png", title: "Recent Activity" },
];
